        ...
        <div className="mt-10 mx-4 px-5 flex flex-col justify-between items-start w-[97%]">
          ...
          <ol className="pl-5 !list-decimal flex flex-col gap-2">
            ...
            <li className="pb-1">
              ...
              Executable (.exe) File [Version 1.0] - December 11, 2023 and
            ...
            <li className="pb-1">
              ...
              on a daily basis at PMS Executable File (.exe). In the event of
              any issues, users should promptly contact the IT team for support.
            </li>
            <li className="pb-1">
              If the user has configured &quot;Turn on Display&quot; and
              &quot;Put the Computer to Sleep&quot; in the Balance power plan to
